...
/**
 * SuscripcionesSearch represents the model behind the search form of `app\models\Suscripciones`.
 */
class SuscripcionesSearch extends Suscripciones
{
    /**
     * {@inheritdoc}
     */
